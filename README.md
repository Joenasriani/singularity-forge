...
- **The Silo** — explorable 2D industrial room. WASD / arrow movement, three interactive nodes (hatch, salvage, locked Weave door). Node state persists in game context. Hover reveals action prompts; keyboard (Enter/Space) activates nodes.
